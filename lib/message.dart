  ...
  Future<void> fetchEmployeeDetails() async {
    try {
      final response = await http.get(
        Uri.parse("https://finalhrm-proj.onrender.com/api/employees/${widget.employeeId}"),
      );
    ...
    if (_msgController.text.isNotEmpty && employeeData != null && senderId != null &&
      ...
      try {
        ...
        final response = await http.post(
          Uri.parse("https://finalhrm-proj.onrender.com/notifications"),
                ...
                children: [
                  ...
                  CircleAvatar(
                    ...
                    backgroundImage: (employeeData?['employeeImage'] != null &&
                        ...
                        ? NetworkImage(
                            "https://finalhrm-proj.onrender.com${employeeData!['employeeImage']}")
