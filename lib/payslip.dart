...
class _PayslipScreenState extends State<PayslipScreen> {
 ...
 late String selectedMonth;
  ...
  Future<int> fetchWorkingDays(String employeeId, int month, int year) async {
    var url = Uri.parse("https://finalhrm-proj.onrender.com/attendance/attendance/history/$employeeId");
  ...
  Future<void> _fetchPayslipDetails() async {
    ...
    final url = Uri.parse(
      'https://finalhrm-proj.onrender.com/get-payslip-details?employee_id=$employeeId&year=$selectedYear&month=$selectedMonth',
    );
