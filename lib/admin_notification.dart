...
try {
  ...
  Future<void> fetchPerformanceNotifications() async {
    final uri = Uri.parse(
        ...
        "https://finalhrm-proj.onrender.com/notifications/performance/admin/$selectedMonth/${widget.empId}");
    final resp = await http.get(uri);
  ...
  final uri = Uri.parse(
      "https://finalhrm-proj.onrender.com/notifications/holiday/admin/$selectedMonth");
  final resp = await http.get(uri);
