...
class _ApplyLeaveState extends State<ApplyLeave> {
  ...
  Future<void> _fetchApprovers(String employeeId) async {
    try {
      final response = await http.get(
        Uri.parse('https://finalhrm-proj.onrender.com/apply/approvers/$employeeId'),
      );
      if (response.statusCode == 200) {
  ...
  void _submitLeave() async {
    ...
    final url = isEditing
        ? 'https://finalhrm-proj.onrender.com/update/$employeeId/$leaveId'
        : 'https://finalhrm-proj.onrender.com/apply/apply-leave';
